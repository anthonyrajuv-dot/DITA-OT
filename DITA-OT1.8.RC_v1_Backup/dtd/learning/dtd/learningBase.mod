...
<!ENTITY % issue.content "(%section.cnt;)*">
...
<!ENTITY % rules.content "(%section.cnt;)*">
<!ENTITY % rules.attributes
             "outputclass CDATA #IMPLIED"
>
<!ELEMENT rules    %rules.content;>
<!ATTLIST rules    %rules.attributes;>



<!ENTITY % analysis.content "(%section.cnt;)*">
<!ENTITY % analysis.attributes
             "outputclass CDATA #IMPLIED"
>
<!ELEMENT analysis    %analysis.content;>
<!ATTLIST analysis    %analysis.attributes;>




<!ENTITY % conclusion.content "(%section.cnt;)*">
<!ENTITY % conclusion.attributes
             "outputclass CDATA #IMPLIED"
>
<!ELEMENT conclusion    %conclusion.content;>
<!ATTLIST conclusion    %conclusion.attributes;>
...
<!ATTLIST issue        %global-atts; class CDATA "- topic/section learningBase/issue ">
