...
--> 
    ...
    <xsl:template name="processAttrSetReflection">
        ...
        <xsl:param name="path"/>
        <xsl:choose>
            <!-- [SP] Add reflections for odd and even headers. -->
            <xsl:when test="$attrSet = 'odd__header'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="odd__header"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <xsl:when test="$attrSet = 'even__header'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="even__header"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <!-- Level-1 Head (No section equivalent at the top level.) -->
            ...
            <!-- [SP] Adding tests for the topic.*.section attribute sets. -->
            <xsl:when test="$attrSet = 'topic.section.title'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.section.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <!-- Level-3 Head -->
            ...
            <xsl:when test="$attrSet = 'topic.topic.section.title'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.section.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <!-- Level-4 Head -->
            ...
            <xsl:when test="$attrSet = 'topic.topic.topic.section.title'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.section.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <!-- Level-5 Head -->
            ...
            <xsl:when test="$attrSet = 'topic.topic.topic.topic.section.title'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.topic.section.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            <!-- Level-6 Head -->
            ...
            <xsl:when test="$attrSet = 'topic.topic.topic.topic.topic.section.title'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.topic.topic.section.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            
            <!-- Level-7! Head -->            
            <xsl:when test="$attrSet = 'topic.topic.topic.topic.topic.topic.section.title'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="topic.topic.topic.topic.topic.topic.section.title"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
            ...
            <xsl:when test="$attrSet = 'note__note'">
                <xsl:call-template name="new-attr-set-reflection">
                    <xsl:with-param name="temp-element">
                        <xsl:element name="placeholder" use-attribute-sets="note__note"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:when>
        </xsl:choose>
