...
<?sp_head Body page treatment. ?>
    ...
    <xsl:variable name="part-number-line-height">29pt</xsl:variable>
    ...
    <xsl:variable name="part-title-line-height">29pt</xsl:variable>
    ...
    <xsl:variable name="chap-appx-number-size">26pt</xsl:variable>
    <xsl:variable name="chap-appx-number-line-height">29pt</xsl:variable>
    ...
    <xsl:variable name="chap-appx-size">26pt</xsl:variable>
    <xsl:variable name="chap-appx-line-height">29pt</xsl:variable>
    ...
    <xsl:variable name="chap-appx-title-size">26pt</xsl:variable>
    <xsl:variable name="chap-appx-title-line-height">29pt</xsl:variable>
    ...
    <xsl:variable name="level-1-size">26pt</xsl:variable>
    <xsl:variable name="level-1-line-height">29pt</xsl:variable>
    ...
    <xsl:variable name="level-2-size">22pt</xsl:variable>
    <xsl:variable name="level-2-line-height">23pt</xsl:variable>
    ...
    <xsl:variable name="level-3-size">18pt</xsl:variable>
    <xsl:variable name="level-3-line-height">20pt</xsl:variable>
    ...
    <xsl:variable name="level-4-size">16pt</xsl:variable>
...
<!--    <xsl:variable name="level-5-family">SansLight</xsl:variable>
    ...
    <xsl:variable name="level-5-size">16pt</xsl:variable>
    <xsl:variable name="level-5-line-height">18pt</xsl:variable>
    ...
    <xsl:variable name="level-6-size">15pt</xsl:variable>
    <xsl:variable name="level-6-line-height">17pt</xsl:variable>
    <xsl:variable name="level-6-weight">bold</xsl:variable>
...
<!--    <xsl:variable name="level-6-family">SansLight</xsl:variable>
    ...
    <?sp_doc Formatting for seventh-level heads. (Pazzo!) ?>
    <xsl:variable name="level-7-family">Sans</xsl:variable>
    <xsl:variable name="level-7-size">14pt</xsl:variable>
    <xsl:variable name="level-7-line-height">16pt</xsl:variable>
    <xsl:variable name="level-7-weight">bold</xsl:variable>
    <xsl:variable name="level-7-style">normal</xsl:variable>
    <xsl:variable name="level-7-indent">0pt</xsl:variable>
    <xsl:variable name="level-7-color">#000000</xsl:variable>
    ...
    <xsl:variable name="table-head-bgcolor">#cccccc</xsl:variable>
