    ...
    <xsl:template name="createDefaultLayoutMasters">
        <fo:layout-master-set>
            ...
            <fo:simple-page-master master-name="front-matter-first" xsl:use-attribute-sets="simple-page-master">
                ...
                <fo:region-after region-name="first-frontmatter-footer" xsl:use-attribute-sets="region-after-frontmatter-first"/>
...
-->                </fo:simple-page-master>
            ...
            <fo:simple-page-master master-name="toc-first" xsl:use-attribute-sets="simple-page-master">
                ...
                <!-- Turn off headers on first page of a flow. -->
                <!--<fo:region-before region-name="odd-toc-header" xsl:use-attribute-sets="region-before"/>-->
                <fo:region-after region-name="odd-toc-footer" xsl:use-attribute-sets="region-after"/>
            </fo:simple-page-master>
...
<!--                <fo:region-before region-name="odd-glossary-header" xsl:use-attribute-sets="region-before"/>-->
            ...
            <!--FINAL-EXAM simple masters-->
            <fo:simple-page-master master-name="final-exam-first" xsl:use-attribute-sets="simple-page-master">
                <fo:region-body xsl:use-attribute-sets="region-body.odd"/>
                <!-- Turn off headers on first page of a flow. -->
                <!--                <fo:region-before region-name="odd-glossary-header" xsl:use-attribute-sets="region-before"/>-->
                <fo:region-after region-name="odd-final-exam-footer" xsl:use-attribute-sets="region-after"/>
            </fo:simple-page-master>
            
            <xsl:if test="$mirror-page-margins">
                <fo:simple-page-master master-name="final-exam-even" xsl:use-attribute-sets="simple-page-master">
                    <fo:region-body xsl:use-attribute-sets="region-body.even"/>
<!--                    <fo:region-before region-name="even-final-exam-header" xsl:use-attribute-sets="region-before"/>
                    <fo:region-after region-name="even-final-exam-footer" xsl:use-attribute-sets="region-after"/>-->
                </fo:simple-page-master>
            </xsl:if>
            
            <fo:simple-page-master master-name="final-exam-odd" xsl:use-attribute-sets="simple-page-master">
                <fo:region-body xsl:use-attribute-sets="region-body.odd"/>
<!--                <fo:region-before region-name="odd-final-exam-header" xsl:use-attribute-sets="region-before"/>
                <fo:region-after region-name="odd-final-exam-footer" xsl:use-attribute-sets="region-after"/>-->
            </fo:simple-page-master>
            
            <!--ANSWER KEY simple masters-->
            <fo:simple-page-master master-name="answer-key-first" xsl:use-attribute-sets="simple-page-master">
                <!--<fo:region-before region-name="odd-answer-key-header" xsl:use-attribute-sets="region-before"/>-->
                <fo:region-body xsl:use-attribute-sets="region-body__answer-key.first"/>
                <fo:region-after region-name="odd-answer-key-footer" xsl:use-attribute-sets="region-after"/>
            </fo:simple-page-master>
            
            <xsl:if test="$mirror-page-margins">
                <fo:simple-page-master master-name="answer-key-even" xsl:use-attribute-sets="simple-page-master">
                    <fo:region-body xsl:use-attribute-sets="region-body__answer-key.even"/>
                    <fo:region-before region-name="even-answer-key-header" xsl:use-attribute-sets="region-before"/>
                    <fo:region-after region-name="even-answer-key-footer" xsl:use-attribute-sets="region-after"/>
                </fo:simple-page-master>
            </xsl:if>
            
            <fo:simple-page-master master-name="answer-key-odd" xsl:use-attribute-sets="simple-page-master">
                <fo:region-body xsl:use-attribute-sets="region-body__answer-key.odd"/>
                <fo:region-before region-name="odd-answer-key-header" xsl:use-attribute-sets="region-before"/>
                <fo:region-after region-name="odd-answer-key-footer" xsl:use-attribute-sets="region-after"/>
            </fo:simple-page-master>
            ...
            <xsl:call-template name="generate-page-sequence-master">
                <xsl:with-param name="master-name" select="'final-exam-sequence'"/>
                <xsl:with-param name="master-reference" select="'final-exam'"/>
                <xsl:with-param name="first" select="false()"/>
                <xsl:with-param name="last" select="false()"/>
            </xsl:call-template>
            
            <xsl:call-template name="generate-page-sequence-master">
                <xsl:with-param name="master-name" select="'answer-key-sequence'"/>
                <xsl:with-param name="master-reference" select="'answer-key'"/>
                <xsl:with-param name="last" select="false()"/>
            </xsl:call-template>
