...
<!ENTITY % lcTwoPartAnalysis           "lcTwoPartAnalysis">
<!ENTITY % lcProblemSolving           "lcProblemSolving">
<!ENTITY % lcDataSufficiency           "lcDataSufficiency">
<!ENTITY % lcCriticalReasoning           "lcCriticalReasoning">
<!ENTITY % lcMultiSourceReasoningSingle           "lcMultiSourceReasoningSingle">
<!ENTITY % lcMultiSourceReasoningMultiple           "lcMultiSourceReasoningMultiple">
<!ENTITY % lcReadingComprehension           "lcReadingComprehension">
<!ENTITY % lcTableAnalysis           "lcTableAnalysis">
<!ENTITY % lcGraphicsInterpretation           "lcGraphicsInterpretation">
<!ENTITY % lcPrompt2           "lcPrompt2">

<!ENTITY % lcQuestionContextTab           "lcQuestionContextTab">
<!ENTITY % lcQuestionContextTabLabel           "lcQuestionContextTabLabel">
<!ENTITY % lcQuestionContextTabContent           "lcQuestionContextTabContent">

<!ENTITY % lcTabQuestionContext2           "lcTabQuestionContext2">
...
<!ENTITY % lcQuestionContext2        "lcQuestionContext2">
<!ENTITY % lcQuestionContextName        "lcQuestionContextName">
<!ENTITY % lcQuestionContextType        "lcQuestionContextType">
<!ENTITY % lcQuestionContextOptions2        "lcQuestionContextOptions2">
<!ENTITY % lcQuestionPrompt2         "lcQuestionPrompt2">
<!ENTITY % lcOpenAnswer2             "lcOpenAnswer2">
<!ENTITY % essaySection             "essaySection">
...
<!ENTITY % lcAnswerOptionGroupLabel  "lcAnswerOptionGroupLabel">
...
<!-- START: Added by ARV for GMAT on 22-02-2025 -->

<!ENTITY % lcQuestionContextName.content
  "%lcQuestionBase2.content;"
>
<!ENTITY % lcQuestionContextName.attributes
				"%univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContextName    %lcQuestionContextName.content;>
<!ATTLIST lcQuestionContextName    %lcQuestionContextName.attributes;>

<!ENTITY % lcQuestionContextType.content
  "%lcQuestionBase2.content;"
>
<!ENTITY % lcQuestionContextType.attributes
				"%univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContextType    %lcQuestionContextType.content;>
<!ATTLIST lcQuestionContextType    %lcQuestionContextType.attributes;>



<!ENTITY % lcQuestionContextTab.content
	  "((%lcQuestionContextTabLabel;)?,
	   (%lcQuestionContextTabContent;)?)"
>
<!ENTITY % lcQuestionContextTab.attributes
				"%univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContextTab    %lcQuestionContextTab.content;>
<!ATTLIST lcQuestionContextTab    %lcQuestionContextTab.attributes;>



<!ENTITY % lcQuestionContextTabLabel.content
	  "%lcQuestionBase2.content;"
>
<!ENTITY % lcQuestionContextTabLabel.attributes
				"%univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContextTabLabel    %lcQuestionContextTabLabel.content;>
<!ATTLIST lcQuestionContextTabLabel    %lcQuestionContextTabLabel.attributes;>


<!ENTITY % lcQuestionContextTabContent.content
	  "%lcQuestionBase2.content;"
>
<!ENTITY % lcQuestionContextTabContent.attributes
				"%univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContextTabContent    %lcQuestionContextTabContent.content;>
<!ATTLIST lcQuestionContextTabContent    %lcQuestionContextTabContent.attributes;>
...
<!ENTITY % lcQuestionContext2.attributes
              ...
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContext2    %lcQuestionContext2.content;>
<!ATTLIST lcQuestionContext2    %lcQuestionContext2.attributes;>



<!ENTITY % lcTabQuestionContext2.content
	  	"(%lcQuestionContextTab;)+"
>
<!ENTITY % lcTabQuestionContext2.attributes
				"%univ-atts;
				  position CDATA #IMPLIED
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcTabQuestionContext2    %lcTabQuestionContext2.content;>
<!ATTLIST lcTabQuestionContext2    %lcTabQuestionContext2.attributes;>




<!-- END: Added by ARV for GMAT on 22-02-2025 -->




<!-- START: Added by ARV on 08-02-2025 -->
<!ENTITY % lcTwoPartAnalysis.content
                       "((%lcInteractionLabel2;)?,
                         ((%lcQuestionContext2;)?),
                         ((%lcQuestionContextName;)?),
	   						 ((%lcQuestionContextType;)?),
                         (%lcQuestionPrompt2;), 
                         (%lcAsset2;)*,
                         ((%lcAnswerOptionGroup2;)+),
                         (%lcFeedbackIncorrect2;)?,
                         ...
                         (%data;)*)"
>
<!ENTITY % lcTwoPartAnalysis.attributes
             "id
                        NMTOKEN
                                  #IMPLIED
              %univ-atts;
              outputclass
                        CDATA
                                  #IMPLIED"
>
<!ELEMENT lcTwoPartAnalysis    %lcTwoPartAnalysis.content;>
<!ATTLIST lcTwoPartAnalysis    %lcTwoPartAnalysis.attributes;>
<!-- END: Added by ARV on 08-02-2025 -->




<!-- START: Added by ARV on 26-03-2025 -->
<!ENTITY % lcReadingComprehension.content
                       "(
                       	 (%lcInteractionLabel2;)?,
                         ((%lcQuestionContext2;)?),
                         ((%lcQuestionContextName;)?),
                         ...
                         (%data;)*)"
>
<!ENTITY % lcReadingComprehension.attributes
             "id
                        NMTOKEN
                                  #IMPLIED
              %univ-atts;
              outputclass
                        CDATA
                                  #IMPLIED"
>
<!ELEMENT lcReadingComprehension    %lcReadingComprehension.content;>
<!ATTLIST lcReadingComprehension    %lcReadingComprehension.attributes;>
<!-- END: Added by ARV on 26-03-2025 -->



<!-- START: Added by ARV on 27-03-2025 -->
<!ENTITY % lcTableAnalysis.content
                       "(
                       	 (%lcInteractionLabel2;)?,
                         ((%lcQuestionContext2;)?),
                         ((%lcQuestionContextName;)?),
	   						 ((%lcQuestionContextType;)?),
	   						 ((%lcQuestionContextOptions2;)?),
                         (%lcQuestionPrompt2;), 
                         (%lcAsset2;)*,
                         ((%lcAnswerOptionGroup2;)+),
                         (%lcFeedbackIncorrect2;)?,
                         ...
                         (%data;)*)"
>
<!ENTITY % lcTableAnalysis.attributes
             "id
                        NMTOKEN
                                  #IMPLIED
              %univ-atts;
              outputclass
                        CDATA
                                  #IMPLIED"
>
<!ELEMENT lcTableAnalysis    %lcTableAnalysis.content;>
<!ATTLIST lcTableAnalysis    %lcTableAnalysis.attributes;>
<!-- END: Added by ARV on 27-03-2025 -->



<!-- START: Added by ARV on 27-03-2025 -->
<!ENTITY % lcGraphicsInterpretation.content
                       "(
                       	 (%lcInteractionLabel2;)?,
                         ((%lcQuestionContext2;)?),
                         ((%lcQuestionContextName;)?),
                         ...
                         (%data;)*)"
>
<!ENTITY % lcGraphicsInterpretation.attributes
             "id
                        NMTOKEN
                                  #IMPLIED
              %univ-atts;
              outputclass
                        CDATA
                                  #IMPLIED"
>
<!ELEMENT lcGraphicsInterpretation    %lcGraphicsInterpretation.content;>
<!ATTLIST lcGraphicsInterpretation    %lcGraphicsInterpretation.attributes;>
<!-- END: Added by ARV on 27-03-2025 -->




<!-- START: Added by ARV on 28-02-2025 -->
<!ENTITY % lcProblemSolving.content
                       "((%lcQuestionPrompt2;),
                         ...
                         (%data;)*)"
>
<!ENTITY % lcProblemSolving.attributes
             "id NMTOKEN #IMPLIED
              %univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcProblemSolving    %lcProblemSolving.content;>
<!ATTLIST lcProblemSolving    %lcProblemSolving.attributes;>
<!-- END: Added by ARV on 28-02-2025 -->



<!-- START: Added by ARV on 03-02-2025 -->
<!ENTITY % lcDataSufficiency.content
                       "((%lcQuestionPrompt2;),
                         ((%lcQuestionContextName;)? | (%lcQuestionContextType;)? | (%lcInteractionLabel2;)? | (%lcQuestionContext2;)), 
                         (%lcAsset2;)*,
                         ((%lcAnswerOptionGroup2;)+),
                         ...
                         (%data;)*)"
>
<!ENTITY % lcDataSufficiency.attributes
             "id NMTOKEN #IMPLIED
              %univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcDataSufficiency    %lcDataSufficiency.content;>
<!ATTLIST lcDataSufficiency    %lcDataSufficiency.attributes;>
<!-- END: Added by ARV on 03-02-2025 -->



<!-- START: Added by ARV on 03-02-2025 -->
<!ENTITY % lcCriticalReasoning.content
                       "((%lcQuestionPrompt2;),
                         ((%lcQuestionContextName;)? | (%lcQuestionContextType;)? | (%lcInteractionLabel2;)? | (%lcQuestionContext2;)), 
                         (%lcAsset2;)*,
                         ((%lcAnswerOptionGroup2;)+),
                         ...
                         (%data;)*)"
>
<!ENTITY % lcCriticalReasoning.attributes
             "id NMTOKEN #IMPLIED
              %univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcCriticalReasoning    %lcCriticalReasoning.content;>
<!ATTLIST lcCriticalReasoning    %lcCriticalReasoning.attributes;>
<!-- END: Added by ARV on 03-02-2025 -->



<!-- START: Added by ARV on 02-03-2025 -->
<!ENTITY % lcMultiSourceReasoningSingle.content
                       "(
                         (%lcInteractionLabel2;)?,
                         ((%lcTabQuestionContext2;)?),
                         ((%lcQuestionContextName;)?),
	   						 ((%lcQuestionContextType;)?),
                         (%lcQuestionPrompt2;), 
                         (%lcAsset2;)*,
                         ...
                         (%data;)*)
	   						"
>
<!ENTITY % lcMultiSourceReasoningSingle.attributes
             "id NMTOKEN #IMPLIED
              %univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcMultiSourceReasoningSingle    %lcMultiSourceReasoningSingle.content;>
<!ATTLIST lcMultiSourceReasoningSingle    %lcMultiSourceReasoningSingle.attributes;>
<!-- END: Added by ARV on 02-03-2025 -->



<!-- START: Added by ARV on 02-03-2025 -->
<!ENTITY % lcMultiSourceReasoningMultiple.content
                       "(
                       	 (%lcInteractionLabel2;)?,
                         ((%lcTabQuestionContext2;)?),
                         ((%lcQuestionContextName;)?),
                         ...
                         (%data;)*)"
>
<!ENTITY % lcMultiSourceReasoningMultiple.attributes
             "id NMTOKEN #IMPLIED
              %univ-atts;
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcMultiSourceReasoningMultiple    %lcMultiSourceReasoningMultiple.content;>
<!ATTLIST lcMultiSourceReasoningMultiple    %lcMultiSourceReasoningMultiple.attributes;>
<!-- END: Added by ARV on 02-03-2025 -->




<!-- START: Added by ARV on 28-03-2025 -->
<!ENTITY % lcPrompt2.content
                       "(
                       	 (%lcInteractionLabel2;)?,
                         ((%lcQuestionContext2;)|(%lcTabQuestionContext2;)),
                         (%lcQuestionContextName;),
	   						 (%lcQuestionContextType;),                         
	   						 ((%lcQuestionContextOptions2;)?),                         
                         (%data;)*)"
>
<!ENTITY % lcPrompt2.attributes
             "id NMTOKEN #IMPLIED
              %univ-atts;
              outputclass CDATA #IMPLIED
              questionType CDATA #IMPLIED"
>
<!ELEMENT lcPrompt2    %lcPrompt2.content;>
<!ATTLIST lcPrompt2    %lcPrompt2.attributes;>
<!-- END: Added by ARV on 28-03-2025 -->
...
<!ENTITY % lcQuestionPrompt2.content
  "%lcQuestionBase2.content;"
>
<!ENTITY % lcQuestionPrompt2.attributes
"
              %univ-atts;
              outputclass
                        CDATA
                                  #IMPLIED"
>
<!ELEMENT lcQuestionPrompt2    %lcQuestionPrompt2.content;>
<!ATTLIST lcQuestionPrompt2    %lcQuestionPrompt2.attributes;>




<!ENTITY % essaySection.content
                       "EMPTY"
>
<!ENTITY % essaySection.attributes
             "keyref CDATA #IMPLIED
              href CDATA #IMPLIED
              product (essay|spe) #IMPLIED
              outputclass CDATA #IMPLIED"
>

<!ELEMENT essaySection    %essaySection.content;>
<!ATTLIST essaySection    %essaySection.attributes;>
...
<!-- ARV -->
<!ENTITY % lcAnswerOptionGroupLabel.content
	"(#PCDATA | 
   %basic.block; | 
   %basic.ph; | 
   %data.elements.incl; | 
 ...
 "
>
<!ENTITY % lcAnswerOptionGroupLabel.attributes
"
              %univ-atts;
              outputclass CDATA #IMPLIED
              append (true|false) #IMPLIED"
>
<!ELEMENT lcAnswerOptionGroupLabel    %lcAnswerOptionGroupLabel.content;>
<!ATTLIST lcAnswerOptionGroupLabel    %lcAnswerOptionGroupLabel.attributes;>
...
<!-- ARV-27-03-2025: For GMAT Table Analysis -->
<!ENTITY % lcQuestionContextOptions2.content
                       "(%select;)"
>
<!ENTITY % lcQuestionContextOptions2.attributes
             "%univ-atts; 
              outputclass CDATA #IMPLIED"
>
<!ELEMENT lcQuestionContextOptions2    %lcQuestionContextOptions2.content;>
<!ATTLIST lcQuestionContextOptions2    %lcQuestionContextOptions2.attributes;>
<!-- ARV-27-03-2025: For GMAT Table Analysis -->
...
<!ENTITY % select.content
 ...
 "
>
<!ENTITY % select.attributes
             "%univ-atts;
              value CDATA #IMPLIED"
>
<!ELEMENT select    %select.content;>
<!ATTLIST select    %select.attributes;>
<!-- ARV-27-03-2025: For GMAT Table Analysis -->
...
<!ATTLIST lcTwoPartAnalysis %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcTwoPartAnalysis ">
<!ATTLIST lcReadingComprehension %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcReadingComprehension ">
<!ATTLIST lcTableAnalysis %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcTableAnalysis ">
<!ATTLIST lcGraphicsInterpretation %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcGraphicsInterpretation ">
<!ATTLIST lcPrompt2 %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcPrompt2 ">
<!ATTLIST lcProblemSolving %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcProblemSolving ">
<!ATTLIST lcDataSufficiency %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcDataSufficiency ">
<!ATTLIST lcCriticalReasoning %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcCriticalReasoning ">
<!ATTLIST lcMultiSourceReasoningSingle %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcMultiSourceReasoningSingle ">
<!ATTLIST lcMultiSourceReasoningMultiple %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcMultiSourceReasoningMultiple ">
<!ATTLIST lcQuestionContextTab %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcQuestionContextTab ">
<!ATTLIST lcQuestionContextTabLabel %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcQuestionContextTabLabel ">
<!ATTLIST lcQuestionContextTabContent %global-atts;
...
<!ATTLIST lcQuestionContextName %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcQuestionContextName ">    

<!ATTLIST lcQuestionContextType %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcQuestionContextType ">    
<!ATTLIST lcQuestionContextOptions2 %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcQuestionContextOptions2 ">    
    
<!ATTLIST lcQuestionPrompt2 %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcQuestionPrompt2 ">
<!ATTLIST lcAnswerOptionGroupLabel %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/lcInteractionBase learning2-d/lcAnswerOptionGroupLabel ">
...
<!ATTLIST essaySection %global-atts;
    class CDATA "+ topic/div learningInteractionBase2-d/div learning2-d/essaySection ">
...
<!ATTLIST select   %global-atts;  
    class CDATA "+ topic/ph learningInteractionBase2-d/ph learning-d/select "    > 
<!ATTLIST option   %global-atts;  
    class CDATA "+ topic/ph learningInteractionBase2-d/ph learning-d/option "    > 
