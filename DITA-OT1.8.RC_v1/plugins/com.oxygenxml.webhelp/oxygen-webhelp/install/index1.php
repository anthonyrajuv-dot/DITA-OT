		...
		<td>
		  ...
		  <div class="panel" id="ldapPanel" style="display:none;">
			  ...
			  <table>
				  ...
				  <tr>
					  <td>Scope
						  <div class="settingDesc">Scope used when searching LDAP</div></td>
					  <td>
						  <select id="bindScope" name="bindScope" title="LDAP Search Scope">
							  <option value="LDAP_SCOPE_ONELEVEL" <?php if (LDAP_BIND_SCOPE == 'LDAP_SCOPE_ONELEVEL') echo 'selected="selected"';
							  ?>>One level</option>
							  <option value="LDAP_SCOPE_SUBTREE" <?php if (LDAP_BIND_SCOPE == 'LDAP_SCOPE_SUBTREE') echo 'selected="selected"'; ?>>Tree</option>
						  </select>
					  </td>
				  </tr>
				  <tr>
