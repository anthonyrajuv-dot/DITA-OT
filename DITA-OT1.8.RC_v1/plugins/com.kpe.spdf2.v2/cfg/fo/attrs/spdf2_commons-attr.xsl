...
<!-- xxxxx -->
    ...
    <xsl:attribute-set name="topic.topic.topic.topic.topic.topic.section.title"
        use-attribute-sets="base-font common.title">
        <xsl:attribute name="font-family">
            <xsl:value-of select="$level-7-family"/>
        </xsl:attribute>
        <xsl:attribute name="font-size">
            <xsl:value-of select="$level-7-size"/>
        </xsl:attribute>
        <xsl:attribute name="line-height">
            <xsl:value-of select="$level-7-line-height"/>
        </xsl:attribute>
        <xsl:attribute name="font-weight">
            <xsl:value-of select="$level-7-weight"/>
        </xsl:attribute>
        <xsl:attribute name="font-style">
            <xsl:value-of select="$level-7-style"/>
        </xsl:attribute>
        <xsl:attribute name="margin-left">
            <xsl:value-of select="$level-7-indent"/>
        </xsl:attribute>
        <xsl:attribute name="color">
            <xsl:value-of select="$level-7-color"/>
        </xsl:attribute>
        <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute>
    </xsl:attribute-set>
...
<!--            <xsl:choose>
	...
	<!--ARV_26-03-2025 Special for question numbering-->
	 <xsl:attribute-set name="lcQuestionPrompt2" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for question numbering-->
	<xsl:attribute-set name="lcMultiSourceReasoningMultiple" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for question numbering-->
	<xsl:attribute-set name="lcMultiSourceReasoningSingle" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for question numbering-->
	<xsl:attribute-set name="lcGraphicsInterpretation" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for lcQuestionContextName -->
	<xsl:attribute-set name="lcQuestionContextName" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for lcQuestionContextType -->
	<xsl:attribute-set name="lcQuestionContextType" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for lcQuestionContextOptions2 -->
	<xsl:attribute-set name="lcQuestionContextOptions2" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
	...
	<!--ARV_17-04-2025 Special for lcAnswerOptionGroupLabel -->
	<xsl:attribute-set name="lcAnswerOptionGroupLabel" use-attribute-sets="common.block">
        <xsl:attribute name="font-size">
            <xsl:value-of select="$default-font-size"/>
        </xsl:attribute>
        <xsl:attribute name="text-indent">0em</xsl:attribute>
