...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="externalLinks" select="$resolved//*[@href][contains(@class, ' topic/xref ') or contains(@class, ' topic/link ') or (contains(@class, ' map/topicref '))][@format != 'dita' and @format != 'ditamap' and @format != '']"/>
