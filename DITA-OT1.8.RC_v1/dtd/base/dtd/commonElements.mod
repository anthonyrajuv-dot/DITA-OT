...
<!--                    LONG NAME: Aside (Streaming/Executable 
                                   Data)                           -->
<!-- Added to contain alt text of images.       -->
<!ENTITY % aside.content
                       "((%p;))"
>
<!ENTITY % aside.attributes
             "%univ-atts;
              outputclass CDATA #IMPLIED 
              "
>
...
<!ATTLIST aside      %global-atts;  class CDATA "- topic/aside "       >
