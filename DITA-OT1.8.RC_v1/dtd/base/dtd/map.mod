...
<!ENTITY % sampleQuestion   "sampleQuestion"                         >
<!ENTITY % sampleAnswer   "sampleAnswer"                             >
...
<!ENTITY % essayData.attributes
             "%univ-atts;
              ...
              ptType (brief|essay_bank|letter|memo|other|diagnostic|spe) #IMPLIED"
>
...
<!ENTITY % sampleQuestion.content
                       "EMPTY"
>
<!ENTITY % sampleQuestion.attributes
              "url CDATA #REQUIRED"
>

<!ELEMENT sampleQuestion    %sampleQuestion.content;>
<!ATTLIST sampleQuestion    %sampleQuestion.attributes;>
...
<!ENTITY % sampleAnswer.content
                       "EMPTY"
>
<!ENTITY % sampleAnswer.attributes
              "url CDATA #REQUIRED"
>

<!ELEMENT sampleAnswer    %sampleAnswer.content;>
<!ATTLIST sampleAnswer    %sampleAnswer.attributes;>
...
<!ATTLIST essayData   %global-atts;  class CDATA "- map/essayData "  >
<!ATTLIST essaySection   %global-atts;  class CDATA "- map/essaySection "  >
<!ATTLIST sampleQuestion   %global-atts;  class CDATA "- map/sampleQuestion "  >
<!ATTLIST sampleAnswer   %global-atts;  class CDATA "- map/sampleAnswer "  >
