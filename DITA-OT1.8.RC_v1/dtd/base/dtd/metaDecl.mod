...
<!--                    LONG NAME: Performance Type                        -->
<!ENTITY % performance.content
                       "EMPTY"
>
<!ENTITY % performance.attributes
             "type (brief|essay_bank|letter|memo|other|spe) #REQUIRED"
>
<!ELEMENT performance    %performance.content;>
<!ATTLIST performance    %performance.attributes;>
...
<!--                    LONG NAME: Offering Type                        -->
<!ENTITY % offering.content
                       "EMPTY"
>
<!ENTITY % offering.attributes
             "type (essay|nexGen|mixed|other) #REQUIRED
              pt (yes|no) #REQUIRED
              spe (yes|no) #REQUIRED
              openanswer (yes|no) #IMPLIED
              href CDATA #IMPLIED"
>
<!ELEMENT offering    %offering.content;>
<!ATTLIST offering    %offering.attributes;>




<!--                    LONG NAME: prodsubtype                        -->
<!ENTITY % prodsubtype.content
                       "EMPTY"
>
<!ENTITY % prodsubtype.attributes
             "subtype CDATA #IMPLIED
              trunk-identifier (yes|no) #IMPLIED"
>
