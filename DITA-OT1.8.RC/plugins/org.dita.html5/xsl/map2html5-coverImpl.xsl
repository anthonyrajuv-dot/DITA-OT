...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:dita-ot="http://dita-ot.sourceforge.net/ns/201007/dita-ot" version="2.0" exclude-result-prefixes="xs dita-ot">
  ...
  <xsl:import href="plugin:org.dita.html5:xsl/map2html5Impl.xsl"></xsl:import>  
  ...
  <xsl:template match="*[contains(@class, &apos; map/map &apos;)]" mode="chapterBody">
    <body>
      ...
      <xsl:variable name="map" as="element()*">
        <xsl:apply-templates select="." mode="normalize-map"></xsl:apply-templates>
      </xsl:variable>
      <xsl:apply-templates select="$map" mode="toc"></xsl:apply-templates>
