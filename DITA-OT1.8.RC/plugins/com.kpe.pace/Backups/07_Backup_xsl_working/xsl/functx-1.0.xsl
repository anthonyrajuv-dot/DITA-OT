...
-->
	<xsl:function name="functx:abbr-UsState" as="xs:string?">
		<xsl:param name="arg" as="xs:string?"/>
	<xsl:choose>
		<xsl:when test="$arg = 'Alabama' "><xsl:sequence select=" 'AL' "/></xsl:when>
		<xsl:when test="$arg = 'Alaska' "><xsl:sequence select=" 'AK' "/></xsl:when>
		<xsl:when test="$arg = 'Arizona' "><xsl:sequence select=" 'AZ' "/></xsl:when>
		<xsl:when test="$arg = 'Arkansas' "><xsl:sequence select=" 'AR' "/></xsl:when>
		<xsl:when test="$arg = 'California' "><xsl:sequence select=" 'CA' "/></xsl:when>
		<xsl:when test="$arg = 'Colorado' "><xsl:sequence select=" 'CO' "/></xsl:when>
		<xsl:when test="$arg = 'Connecticut' "><xsl:sequence select=" 'CT' "/></xsl:when>
		<xsl:when test="$arg = 'Delaware' "><xsl:sequence select=" 'DE' "/></xsl:when>
		<xsl:when test="$arg = 'Florida' "><xsl:sequence select=" 'FL' "/></xsl:when>
		<xsl:when test="$arg = 'Georgia' "><xsl:sequence select=" 'GA' "/></xsl:when>
		<xsl:when test="$arg = 'Hawaii' "><xsl:sequence select=" 'HI' "/></xsl:when>
		<xsl:when test="$arg = 'Idaho' "><xsl:sequence select=" 'ID' "/></xsl:when>
		<xsl:when test="$arg = 'Illinois' "><xsl:sequence select=" 'IL' "/></xsl:when>
		<xsl:when test="$arg = 'Indiana' "><xsl:sequence select=" 'IN' "/></xsl:when>
		<xsl:when test="$arg = 'Iowa' "><xsl:sequence select=" 'IA' "/></xsl:when>
		<xsl:when test="$arg = 'Kansas' "><xsl:sequence select=" 'KS' "/></xsl:when>
		<xsl:when test="$arg = 'Kentucky' "><xsl:sequence select=" 'KY' "/></xsl:when>
		<xsl:when test="$arg = 'Louisiana' "><xsl:sequence select=" 'LA' "/></xsl:when>
		<xsl:when test="$arg = 'Maine' "><xsl:sequence select=" 'ME' "/></xsl:when>
		<xsl:when test="$arg = 'Maryland' "><xsl:sequence select=" 'MD' "/></xsl:when>
		<xsl:when test="$arg = 'Massachusetts' "><xsl:sequence select=" 'MA' "/></xsl:when>
		<xsl:when test="$arg = 'Michigan' "><xsl:sequence select=" 'MI' "/></xsl:when>
		<xsl:when test="$arg = 'Minnesota' "><xsl:sequence select=" 'MN' "/></xsl:when>
		<xsl:when test="$arg = 'Mississippi' "><xsl:sequence select=" 'MS' "/></xsl:when>
		<xsl:when test="$arg = 'Missouri' "><xsl:sequence select=" 'MO' "/></xsl:when>
		<xsl:when test="$arg = 'Montana' "><xsl:sequence select=" 'MT' "/></xsl:when>
		<xsl:when test="$arg = 'Nebraska' "><xsl:sequence select=" 'NE' "/></xsl:when>
		<xsl:when test="$arg = 'Nevada' "><xsl:sequence select=" 'NV' "/></xsl:when>
		<xsl:when test="$arg = 'New Hampshire' "><xsl:sequence select=" 'NH' "/></xsl:when>
		<xsl:when test="$arg = 'New Jersey' "><xsl:sequence select=" 'NJ' "/></xsl:when>
		<xsl:when test="$arg = 'New Mexico' "><xsl:sequence select=" 'NM' "/></xsl:when>
		<xsl:when test="$arg = 'New York' "><xsl:sequence select=" 'NY' "/></xsl:when>
		<xsl:when test="$arg = 'North Carolina' "><xsl:sequence select=" 'NC' "/></xsl:when>
		<xsl:when test="$arg = 'North Dakota' "><xsl:sequence select=" 'ND' "/></xsl:when>
		<xsl:when test="$arg = 'Ohio' "><xsl:sequence select=" 'OH' "/></xsl:when>
		<xsl:when test="$arg = 'Oklahoma' "><xsl:sequence select=" 'OK' "/></xsl:when>
		<xsl:when test="$arg = 'Oregon' "><xsl:sequence select=" 'OR' "/></xsl:when>
		<xsl:when test="$arg = 'Pennsylvania' "><xsl:sequence select=" 'PA' "/></xsl:when>
		<xsl:when test="$arg = 'Rhode Island' "><xsl:sequence select=" 'RI' "/></xsl:when>
		<xsl:when test="$arg = 'South Carolina' "><xsl:sequence select=" 'SC' "/></xsl:when>
		<xsl:when test="$arg = 'South Dakota' "><xsl:sequence select=" 'SD' "/></xsl:when>
		<xsl:when test="$arg = 'Tennessee' "><xsl:sequence select=" 'TN' "/></xsl:when>
		<xsl:when test="$arg = 'Texas' "><xsl:sequence select=" 'TX' "/></xsl:when>
		<xsl:when test="$arg = 'Utah' "><xsl:sequence select=" 'UT' "/></xsl:when>
		<xsl:when test="$arg = 'Vermont' "><xsl:sequence select=" 'VT' "/></xsl:when>
		<xsl:when test="$arg = 'Virginia' "><xsl:sequence select=" 'VA' "/></xsl:when>
		<xsl:when test="$arg = 'Washington' "><xsl:sequence select=" 'WA' "/></xsl:when>
		<xsl:when test="$arg = 'West Virginia' "><xsl:sequence select=" 'WV' "/></xsl:when>
		<xsl:when test="$arg = 'Wisconsin' "><xsl:sequence select=" 'WI' "/></xsl:when>
		<xsl:when test="$arg = 'Wyoming' "><xsl:sequence select=" 'WY' "/></xsl:when>
		<xsl:otherwise>
			<xsl:message terminate="yes">ERROR: Provide proper US State name for
...
<!--
  Return questionNumber of a string (Bar Essay) 

 @author  Anthony Raju, Kaplan 
 @version 1.0
 @param   $arg1 $arg2 $arg3 $arg4 the word or phrase to abbreviate
-->
	<xsl:function name="functx:questionNumber" as="xs:anyAtomicType*">
		<xsl:param name="arg1" as="xs:string?"/>
		<xsl:param name="arg2" as="xs:string?"/>
		<xsl:param name="arg3" as="xs:string?"/>
		<xsl:param name="arg4" as="xs:integer?"/>
		<xsl:sequence select="     concat( functx:abbr-UsState($arg1),functx:last-two-num-year($arg2),functx:first-three-let-month($arg3),functx:addZeroToQ-num($arg4) )  "/>
	</xsl:function>
