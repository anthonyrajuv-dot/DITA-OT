...
-->
	...
	<!--added ARV: For GMAT 20/05/2025-->
	<xsl:template
		match="m:mfrac[ancestor::equation-inline] | m:munder[ancestor::equation-inline]"
		mode="#all" priority="100">
		<xsl:param name="type"/>
		<m:mstyle mathsize="13.3pt">
	...
	<!--added ARV: For GMAT 20/05/2025-->
	<xsl:template match="m:munderover[ancestor::equation-inline]"
		mode="#all" priority="100">
		<xsl:param name="type"/>
		<m:mstyle mathsize="12.3pt">
			<xsl:element name="m:{local-name()}" namespace="http://www.w3.org/1998/Math/MathML">
					<xsl:apply-templates mode="identity">
						<xsl:with-param name="type" select="$type"/>
					</xsl:apply-templates>
	...
	<!--added ARV: For GMAT 20/05/2025 : Removed on 01/06/2025-->
	<xsl:template match="m:mfrac[ancestor::equation-block]" mode="#all" priority="100">
		<xsl:param name="type"/>
		<m:mstyle mathsize="15pt">
			<xsl:element name="m:{local-name()}" namespace="http://www.w3.org/1998/Math/MathML">
				<xsl:apply-templates mode="identity">
					<xsl:with-param name="type" select="$type"/>
				</xsl:apply-templates>
...
<!--New functionality for D heads in <sectiondiv>-->
	...
	<!--    ARV added 23/05/2025 for GMAT Paragraph -->
